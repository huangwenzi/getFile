...
# 自写模块
import control.getHtml as GetHtmlMd
# from control.getFile import GetFile

# 公司地址 http://127.0.0.1:11000/idxen
...
#     return GetHtmlMd.getGame(filename)
# # 获取路径下文件
...
# @get('/getDogFood')
# def callback():
#     return GetHtmlMd.getDogFood()


# 获取网站主页
@get('/idxen')
def callback():
    return GetHtmlMd.get_idxen()
# 获取某个文件
